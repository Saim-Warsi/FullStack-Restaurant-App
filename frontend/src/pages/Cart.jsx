...
//  return (
//   <div className="cart md:mt-24 mt-16 px-4 md:px-8 lg:px-16">
   
//    <div className="cart-items">
    
//   <div className="cart-item-title grid grid-cols-[1fr_1.5fr_1fr_1fr_0.5fr_0.5fr] items-center text-gray-600 text-sm md:text-base lg:text-lg">       <p>Items</p> <p>Title</p> <p>Price</p> 
//      <p className="">Quantity</p> <p className="">Total</p> <p>Remove</p> 
   
//     </div>
//     <br />
//     <hr className="h-[1px] bg-gray-500 border-none hidden sm:block"/>
//     {food_list.map((item, index) => {
//      if (cartItems[item._id] > 0) {
//       return (
//       <span key={index}>
//    <div  className="cart-items-item my-4 grid grid-cols-[1fr_1.5fr_1fr_1fr_0.5fr_0.5fr] items-center text-black text-sm md:text-base lg:text-lg ">
//         <img src={url+"/images/"+item.image} alt="" className="w-12 md:w-16 rounded-md"/> 
//         <p >{item.name}</p> <p>${item.price}</p> 
//         <p className="">x{cartItems[item._id]}</p>
//         <p className="">${cartItems[item._id] * item.price}</p> 
//         <img className="cursor-pointer w-4 md:w-5 ms-3 sm:ms-5" src={assets.cross_icon} onClick={()=>removeFromCart(item._id)} /> 
//        </div>
...
//    </div>
//      <div className="mt-12 md:mt-20 flex flex-col md:flex-row justify-between gap-8 md:gap-12 lg:gap-16 ">
//       <div className="flex flex-1 flex-col gap-4 md:gap-5">
//        <h2 className="text-xl md:text-2xl font-semibold text-green-900">Cart Totals</h2>
...
//        </div>
//       <button className=" border-2 border-yellow-300 bg-yellow-300 hover:bg-white hover:border-green-900 transition rounded-full py-2 w-full md:w-[max(16vw,220px)] cursor-pointer" onClick={()=>navigate("/order")}  disabled={getTotalCartAmount() === 0}>Proceed to checkout</button>
//       </div>
//      <div className="promocode flex-1">
//       <div className="">
//        <p>If you have a promo code, enter it here</p>
//        <div className="promoinput flex gap-2 mt-2 justify-between items-center bg-[#eaeaea] rounded-full p-1">
//         <input type="text" placeholder="Promo code" className="bg-transparent border-none outline-none pl-2 flex-grow" />
//         <button  className="bg-black border-none text-white rounded-full  py-2 px-3 w-32 sm:w-40 ">Submit</button>
//        </div>
//       </div>
//      </div>
//      </div>
